...
type LoaderType = 'stats' | 'table' | 'charts' | 'top_customers';
...
export default function SkeletonLoader({ type }: SkeletonLoaderProps) {
      ...
      <div className="divide-y divide-slate-100 p-5 space-y-4">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="flex items-center justify-between py-2">
            ...
            <div className="h-5 bg-slate-200 rounded-full w-14 mx-8" />
  ...
  const renderCharts = () => (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E5E7EB] space-y-6 max-w-2xl mx-auto">
