    ...
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E5E7EB] space-y-4">
      <div>
        <h3 className="font-extrabold text-sm text-[#1F2937] uppercase tracking-wider flex items-center">
          <Sparkles size={16} className="text-[#FFD200] mr-1.5 shrink-0" />
      ...
      <div className="space-y-3">
        {topCustomers.map((customer) => (
          <div 
            ...
            className="flex items-center justify-between p-3.5 bg-[#F4F9F6]/50 border border-[#E5E7EB]/50 rounded-xl hover:bg-[#F4F9F6] transition-all cursor-pointer group"
          >
            <div className="flex items-center space-x-3.5 overflow-hidden">
              ...
              <div className="overflow-hidden">
                <h4 className="font-extrabold text-xs text-[#1F2937] truncate group-hover:text-[#00B074] transition-colors">
                  {customer.name}
                </h4>
