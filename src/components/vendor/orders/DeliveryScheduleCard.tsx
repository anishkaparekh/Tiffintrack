    ...
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E5E7EB] space-y-4">
      <div>
        <h3 className="font-extrabold text-sm text-[#1F2937] uppercase tracking-wider flex items-center">
          <CalendarRange size={16} className="text-[#00B074] mr-1.5 shrink-0" />
      ...
      <div className="relative pl-5 space-y-4 pt-1">
        ...
        {scheduleItems.map((item, idx) => (
          <div key={idx} className="relative flex items-start space-x-3.5 group">
            {/* Timeline dot */}
            <div className="absolute -left-[23px] w-3.5 h-3.5 rounded-full bg-white border-2 border-[#00B074] flex items-center justify-center z-10 transition-colors group-hover:bg-[#00B074]">
              <div className="w-1 h-1 rounded-full bg-white" />
            </div>

            {/* Slot Details */}
            <div className="flex-1 p-3 bg-slate-50/50 hover:bg-[#F4F9F6] border border-[#E5E7EB]/50 hover:border-[#00B074]/30 rounded-xl transition-all flex items-center justify-between">
              <div>
              ...
              <div className="text-right shrink-0">
                <span className="bg-[#00B074]/10 text-[#00B074] text-[10px] font-black px-2.5 py-1 rounded-lg">
