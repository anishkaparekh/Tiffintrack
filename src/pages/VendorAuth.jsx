...
export default function VendorAuth() {
  ...
  const validateSignUp = () => {
    ...
    if (!signUpData.kitchenAddress.trim()) {
  ...
  return (
    <div className="min-h-screen bg-snow flex flex-col justify-between relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto w-full px-4 py-6 flex-grow flex flex-col justify-center">
        ...
        <div className="bg-white rounded-3xl border border-slate-200/50 shadow-card overflow-hidden grid lg:grid-cols-12 min-h-[600px]">
          
          {/* Left Column: Business Welcome Section */}
          <div className="hidden lg:flex lg:col-span-5 bg-mint-light/40 p-10 flex-col justify-between border-r border-slate-200/50">
            <div>
              ...
              <h2 className="text-2xl font-extrabold text-primary-text leading-tight mb-3">
                Grow Your Tiffin Business with TiffinTrack
              </h2>
              
              <p className="text-xs text-secondary-text leading-relaxed mb-6">
                Join our platform and connect with customers looking for fresh, home-cooked meals every day.
              </p>
              
              {/* Business Benefits */}
              <div className="space-y-3 mb-6">
                <div className="flex items-center space-x-3 text-xs font-semibold text-primary-text">
                  <div className="w-5 h-5 rounded-md bg-mint/10 flex items-center justify-center text-mint">
                    <Check size={14} strokeWidth={3} />
                  </div>
                  <span>Manage Customers & Subscriptions</span>
                </div>
                <div className="flex items-center space-x-3 text-xs font-semibold text-primary-text">
                  <div className="w-5 h-5 rounded-md bg-mint/10 flex items-center justify-center text-mint">
                    <Check size={14} strokeWidth={3} />
                  </div>
                  <span>Weekly Menu Planning & Adjustments</span>
                </div>
                <div className="flex items-center space-x-3 text-xs font-semibold text-primary-text">
                  <div className="w-5 h-5 rounded-md bg-mint/10 flex items-center justify-center text-mint">
                    <Check size={14} strokeWidth={3} />
                ...
                <div className="flex items-center space-x-3 text-xs font-semibold text-primary-text">
                  ...
                  <span>Detailed Revenue & Growth Insights</span>
                </div>
              </div>
            </div>

            {/* Generated Chef Business Image */}
            <div className="my-1 relative flex justify-center">
              <div className="relative w-full max-w-[220px] aspect-square rounded-2xl overflow-hidden shadow-sm border border-slate-200/60 bg-white p-2">
                <img 
                  src={chefImg} 
                  alt="Professional home chef packaging healthy tiffin boxes" 
            ...
            <blockquote className="border-l-4 border-mint pl-4 mt-4">
              <p className="text-xs italic text-secondary-text leading-relaxed">
                "Great food deserves great customers. Manage subscriptions, menus, and deliveries from one place."
              </p>
            </blockquote>
          </div>
          ...
          <div className="col-span-12 lg:col-span-7 p-6 sm:p-10 flex flex-col justify-center bg-white">
            <div className="max-w-xl mx-auto w-full">
              ...
              {/* Authentication Tabs */}
              <div className="flex bg-snow p-1 rounded-2xl mb-6 border border-slate-200/45">
                <button
                  type="button"
                  onClick={() => {
                    setActiveTab('signin');
                ...
                <>
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="rememberMe" className="ml-2 block text-[11px] font-semibold text-secondary-text cursor-pointer select-none">
                      Keep me logged in to merchant console
                    </label>
                  </div>
              ...
              {activeTab === 'signup' && (
                <form onSubmit={handleSignUpSubmit} className="space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-9 pr-4 py-2.5 bg-snow border ${
                            errors.businessName ? 'border-red-500 focus:border-red-500' : 'border-slate-200 focus:border-mint'
                          } rounded-xl text-xs text-primary-text placeholder-slate-400 focus:outline-none transition-colors duration-200`}
                        />
                      </div>
                      {errors.businessName && (
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-9 pr-4 py-2.5 bg-snow border ${
                            errors.ownerName ? 'border-red-500 focus:border-red-500' : 'border-slate-200 focus:border-mint'
                          } rounded-xl text-xs text-primary-text placeholder-slate-400 focus:outline-none transition-colors duration-200`}
                        />
                      </div>
                      {errors.ownerName && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
                    <div className="space-y-1 sm:col-span-8">
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="text"
                          name="kitchenAddress"
                          value={signUpData.kitchenAddress}
                          onChange={handleSignUpChange}
                          placeholder="Plot 45, Sector 2"
                          className={`w-full pl-9 pr-4 py-2.5 bg-snow border ${
                            errors.kitchenAddress ? 'border-red-500 focus:border-red-500' : 'border-slate-200 focus:border-mint'
                          } rounded-xl text-xs text-primary-text placeholder-slate-400 focus:outline-none transition-colors duration-200`}
                        />
                      </div>
                      {errors.kitchenAddress && (
                        <p className="text-[10px] text-red-500 font-semibold flex items-center space-x-1 mt-1">
                          <AlertCircle size={12} />
                          <span>{errors.kitchenAddress}</span>
                        </p>
                      )}
                    </div>
                    ...
                    <div className="space-y-1 sm:col-span-4">
                      ...
                      <input
                        ...
                        onChange={handleSignUpChange}
                        placeholder="Mumbai"
                        className={`w-full px-4 py-2.5 bg-snow border ${
                          errors.city ? 'border-red-500 focus:border-red-500' : 'border-slate-200 focus:border-mint'
                        } rounded-xl text-xs text-primary-text placeholder-slate-400 focus:outline-none transition-colors duration-200`}
                      />
                      {errors.city && (
                        <p className="text-[10px] text-red-500 font-semibold flex items-center space-x-1 mt-1">
                  ...
                  <div className="border-t border-slate-100 pt-2 mt-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
                      <div className="space-y-1 sm:col-span-4">
                        <label className="text-[9px] font-bold text-secondary-text uppercase block">
                          Daily Capacity
                        </label>
                        <input
                          type="number"
                          name="mealsPerDay"
                          value={signUpData.mealsPerDay}
                          onChange={handleSignUpChange}
                          placeholder="Meals/Day"
                          className="w-full px-3 py-2 bg-snow border border-slate-200 rounded-xl text-xs text-primary-text focus:outline-none focus:border-mint"
                        />
                      </div>
                      <div className="space-y-1 sm:col-span-8">
                        <label className="text-[9px] font-bold text-secondary-text uppercase block">
                        ...
                        <input
                          ...
                          onChange={handleSignUpChange}
                          placeholder="e.g. South Indian specialties"
                          className="w-full px-3 py-2 bg-snow border border-slate-200 rounded-xl text-xs text-primary-text focus:outline-none focus:border-mint"
                        />
                      </div>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <label htmlFor="termsAccepted" className="ml-2 block text-xs font-semibold text-secondary-text cursor-pointer select-none">
                      I agree to the TiffinTrack Vendor <a href="#" className="text-mint hover:underline">Merchant Terms</a>
                    </label>
                  </div>
                  ...
                  >
                    {isLoading ? (
                      <>
                        <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                        <span>Setting Up Kitchen Account...</span>
                      </>
                    ) : (
